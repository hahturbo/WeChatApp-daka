...
Component({
  ...
  lifetimes: {
    ready: function () {
      wx.getImageInfo({
        src: `https://wxda.hahaturbo.site/daka-img/tick-YES.png`,
        success: (res) => {
          this.setData({
            tickYES: res.path
          })
      ...
      wx.getImageInfo({
        src: `https://wxda.hahaturbo.site/daka-img/code.jpg`,
        success: (res) => {
          this.setData({
            code: res.path
          })
  ...
  methods: {
    Drawshare: function () {
      ...
      // res.path=`https://wxda.hahaturbo.site/daka-img/tick-YES.png`
