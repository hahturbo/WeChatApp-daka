...
Page({
  ...
  onShareAppMessage: function (e) {
    let shareGoal = this.$state.aimCardDatas[0]
      ? this.$state.aimCardDatas[0]
      : this.$state.CardData[e.target.dataset.index];
    return {
      title:
        shareGoal.groupData.groupMembers[0].nickname + "邀请您一起和TA打卡",
      desc: "分享页面的内容",
